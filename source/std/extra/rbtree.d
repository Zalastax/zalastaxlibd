...
*/
final class MyRedBlackTree(T, alias less = "a < b", bool allowDuplicates = false)
if(is(typeof(binaryFun!less(T.init, T.init))))
{
    ...
    */
    ...
    /**
    * The range type for $(D MyRedBlackTree)
    */
    struct Range
    {
        private Node _begin;
    ...
    {
        auto ts = new MyRedBlackTree(1, 2, 3, 4, 5);
        assert(ts.length == 5);
        auto r = ts[];
    ...
    * Complexity: $(BIGOH n)
    */
    @property MyRedBlackTree dup()
    {
        return new MyRedBlackTree(_end.dup(), _length);
    }
    ...
    */
    ...
    {
        MyRedBlackTree that = cast(MyRedBlackTree)rhs;
    ...
    static if(doUnittest) unittest
    {
        auto t1 = new MyRedBlackTree(1,2,3,4);
        auto t2 = new MyRedBlackTree(1,2,3,4);
        auto t3 = new MyRedBlackTree(1,2,3,5);
        auto t4 = new MyRedBlackTree(1,2,3,4,5);
        auto o = new Object();
    ...
    */
    ...
    static if(doUnittest) unittest
    {
        auto ts = new MyRedBlackTree(2,1,3,4,5,2,5);
        static if(allowDuplicates)
        {
            assert(ts.length == 7);
    ...
    */
    ...
    Examples:
    --------------------
    auto rbt = myRedBlackTree!true(0, 1, 1, 1, 4, 5, 7);
    rbt.removeKey(1, 4, 7);
    ...
    size_t removeKey(Stuff)(Stuff stuff)
        ...
        {
            //We use array in case stuff is a Range from this MyRedBlackTree - either
    ...
    static if(doUnittest) unittest
    {
        auto rbt = new MyRedBlackTree(5, 4, 3, 7, 2, 1, 7, 6, 2, 19, 45);
    ...
    */
    ...
    very well (likely due to bug# 436 and/or bug# 1528). The myRedBlackTree
...
{
    {
        auto rbt = myRedBlackTree(["hello", "world", "foo", "bar"]);
    ...
    {
        auto rbt = myRedBlackTree([1, 2, 12, 27, 4, 500]);
...
unittest
{
    void test(T)()
    {
        auto rt1 = new MyRedBlackTree!(T, "a < b", false)();
        auto rt2 = new MyRedBlackTree!(T, "a < b", true)();
        auto rt3 = new MyRedBlackTree!(T, "a > b", false)();
        auto rt4 = new MyRedBlackTree!(T, "a > b", true)();
    }
...
/++
Convenience function for creating a $(D MyRedBlackTree!E) from a list of
values.

Examples:
--------------------
auto rbt1 = myRedBlackTree(0, 1, 5, 7);
auto rbt2 = myRedBlackTree!string("hello", "world");
auto rbt3 = myRedBlackTree!true(0, 1, 5, 7, 5);
auto rbt4 = myRedBlackTree!"a > b"(0, 1, 5, 7);
auto rbt5 = myRedBlackTree!("a > b", true)(0.1, 1.3, 5.9, 7.2, 5.9);
--------------------
+/
auto myRedBlackTree(E)(E[] elems...)
{
    return new MyRedBlackTree!E(elems);
}

/++ Ditto +/
auto myRedBlackTree(bool allowDuplicates, E)(E[] elems...)
{
    return new MyRedBlackTree!(E, "a < b", allowDuplicates)(elems);
}

/++ Ditto +/
auto myRedBlackTree(alias less, E)(E[] elems...)
{
    return new MyRedBlackTree!(E, less)(elems);
}

/++ Ditto +/
auto myRedBlackTree(alias less, bool allowDuplicates, E)(E[] elems...)
if(is(typeof(binaryFun!less(E.init, E.init))))
{
    ...
    return new MyRedBlackTree!(E, binaryFun!less, allowDuplicates)(elems);
}
...
unittest
{
    auto rbt1 = myRedBlackTree!(true, string)("hello", "hello");
    auto rbt2 = myRedBlackTree!((a, b){return a < b;}, double)(5.1, 2.3);
    auto rbt3 = myRedBlackTree!("a > b", true, string)("hello", "world");
}

unittest
{
    auto rt1 = myRedBlackTree(5, 4, 3, 2, 1);
    assert(rt1.length == 5);
    assert(array(rt1[]) == [1, 2, 3, 4, 5]);

    auto rt2 = myRedBlackTree!"a > b"(1.1, 2.1);
    assert(rt2.length == 2);
    assert(array(rt2[]) == [2.1, 1.1]);

    auto rt3 = myRedBlackTree!true(5, 5, 4);
    assert(rt3.length == 3);
    assert(array(rt3[]) == [4, 5, 5]);

    auto rt4 = myRedBlackTree!string("hello", "hello");
    assert(rt4.length == 1);
